...
custom_local_manifest = ".repo/local_manifests/rebellion_manifest.xml"
custom_default_revision = "ten"
custom_dependencies = "rebellion.dependencies"
org_manifest = "rebellion-devices"  # leave empty if org is provided in manifest
org_display = "Rebellion-Hub-Devices"  # needed for displaying
